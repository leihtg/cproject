// 线程同步Dlg.cpp : implementation file
//
...
BEGIN_MESSAGE_MAP(CMyDlg, CDialog)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, OnEvent)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
UINT ThreadFunc(LPVOID pParam){
	...
	//pMainWnd->GetDlgItem(IDC_EDIT1)->SetWindowText(CString(pString));
	g_Event.SetEvent();
	return 0;
}
void CMyDlg::OnEvent() 
{
	...
	while(*temp){
		if(i==10){
			char* pStr=g_str;
			AfxBeginThread(ThreadFunc,(LPVOID)pStr);
