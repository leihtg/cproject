...
void CTimeTestDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//	CTimeTestDlg::m_time.Create("Clock",WS_CHILD|WS_VISIBLE,CRect(0,0,100,50),this,123);
}

BEGIN_EVENTSINK_MAP(CTimeTestDlg, CDialog)
    //{{AFX_EVENTSINK_MAP(CTimeTestDlg)
	ON_EVENT(CTimeTestDlg, IDC_TIMECTRL1, 1 /* NewMinute */, OnNewMinuteTimectrl1, VTS_NONE)
	//}}AFX_EVENTSINK_MAP
END_EVENTSINK_MAP()

void CTimeTestDlg::OnNewMinuteTimectrl1() 
{
	MessageBox("新的一分钟");	
}
