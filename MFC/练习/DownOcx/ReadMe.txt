========================================================================
		ActiveX Control DLL : DOWNOCX
========================================================================

ControlWizard has created this project for your DOWNOCX ActiveX Control
...
that make up your DOWNOCX ActiveX Control DLL.
...
DownOcxCtl.h
	This file contains the declaration of the CDownOcxCtrl C++ class.

DownOcxCtl.cpp
	This file contains the implementation of the CDownOcxCtrl C++ class.

DownOcxPpg.h
	This file contains the declaration of the CDownOcxPropPage C++ class.

DownOcxPpg.cpp
	This file contains the implementation of the CDownOcxPropPage C++ class.

DownOcxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CDownOcxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file DownOcx.rc.
