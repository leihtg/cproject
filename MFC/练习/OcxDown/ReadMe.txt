========================================================================
		ActiveX Control DLL : OCXDOWN
========================================================================

ControlWizard has created this project for your OCXDOWN ActiveX Control
...
that make up your OCXDOWN ActiveX Control DLL.
...
OcxDownCtl.h
	This file contains the declaration of the COcxDownCtrl C++ class.

OcxDownCtl.cpp
	This file contains the implementation of the COcxDownCtrl C++ class.

OcxDownPpg.h
	This file contains the declaration of the COcxDownPropPage C++ class.

OcxDownPpg.cpp
	This file contains the implementation of the COcxDownPropPage C++ class.

OcxDownCtl.bmp
	This file contains a bitmap that a container will use to represent the
	COcxDownCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file OcxDown.rc.
