========================================================================
		ActiveX Control DLL : DZDOWNLOADPIC
========================================================================

ControlWizard has created this project for your DZDOWNLOADPIC ActiveX Control
...
that make up your DZDOWNLOADPIC ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
DzDownloadPic control:

DzDownloadPicCtl.h
	This file contains the declaration of the CDzDownloadPicCtrl C++ class.

DzDownloadPicCtl.cpp
	This file contains the implementation of the CDzDownloadPicCtrl C++ class.

DzDownloadPicPpg.h
	This file contains the declaration of the CDzDownloadPicPropPage C++ class.

DzDownloadPicPpg.cpp
	This file contains the implementation of the CDzDownloadPicPropPage C++ class.

DzDownloadPicCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CDzDownloadPicCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file dzDownloadPic.rc.
