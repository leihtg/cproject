========================================================================
		ActiveX Control DLL : OCXDEMO
========================================================================

ControlWizard has created this project for your OCXDEMO ActiveX Control
...
that make up your OCXDEMO ActiveX Control DLL.
...
OcxDemoCtl.h
	This file contains the declaration of the COcxDemoCtrl C++ class.

OcxDemoCtl.cpp
	This file contains the implementation of the COcxDemoCtrl C++ class.

OcxDemoPpg.h
	This file contains the declaration of the COcxDemoPropPage C++ class.

OcxDemoPpg.cpp
	This file contains the implementation of the COcxDemoPropPage C++ class.

OcxDemoCtl.bmp
	This file contains a bitmap that a container will use to represent the
	COcxDemoCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file OcxDemo.rc.
