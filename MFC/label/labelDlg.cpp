...
BEGIN_MESSAGE_MAP(CLabelDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(IDC_STATICd, OnSTATICd)
	ON_BN_CLICKED(IDC_STATICaaa, OnSTATICaaa)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CLabelDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HBRUSH CLabelDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
	...
	if(nCtlColor==CTLCOLOR_STATIC){
		pDC->SetTextColor(RGB(255,23,100));
	}
	// TODO: Return a different brush if the default is not desired
	return hbr;
}

void CLabelDlg::OnSTATICd() 
{
	MessageBox("hello");	
}

void CLabelDlg::OnSTATICaaa() 
{
	MessageBox("hello---");
}
