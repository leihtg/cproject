...
Resource3=IDR_MYTYPE

[CLS:CMyApp]
Type=0
HeaderFile=多文档.h
ImplementationFile=多文档.cpp
Filter=N

[CLS:CMyDoc]
Type=0
HeaderFile=多文档Doc.h
ImplementationFile=多文档Doc.cpp
Filter=N

[CLS:CMyView]
Type=0
HeaderFile=多文档View.h
ImplementationFile=多文档View.cpp
Filter=C
